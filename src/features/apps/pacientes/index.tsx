...
const EMAIL_RE =
  /^[a-z0-9](?:[a-z0-9._%+-]{0,62}[a-z0-9])?@[a-z0-9](?:[a-z0-9-]{0,61}[a-z0-9])?(?:\.[a-z]{2,6})+$/;
const getEmailError = (e: string) =>
  !e ? "E-mail é obrigatório." : EMAIL_RE.test(e.trim()) ? "" : "Formato inválido.";
  ...
  const validateField = (field: string, value: string) => {
    ...
    switch (field) {
      ...
      case "number":
        ...
        else if (!/^\d+$/.test(v)) msg = "Somente dígitos.";
        break;
      case "city":
